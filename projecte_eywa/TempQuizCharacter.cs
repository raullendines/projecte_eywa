...
namespace projecte_eywa
{
    ...
    public class TempQuizCharacter
    {
        ...
        public TempQuizCharacter()
        {

        }


        public TempQuizCharacter(String nameCharacter, String filmCharacter, String categoryCharacter, String difficultyCharacter, int correctNumCharacter, String urlImageCharacter, String descCharacterEsp, String descCharacterEng, String descCharacterCat)
        {
